package com.pay2local.modem.utils
...
data class ResponseDataOfArray<out T>(val status: Status, val data: List<T>?=null, val message: String?=null)
...
fun <T> MutableLiveData<ResponseDataOfArray<T>>.setError(msg: String?=null, data: List<T>?=null) {
